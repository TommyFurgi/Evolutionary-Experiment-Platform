...
public class CliConfig {
    ...
    public static final String DELETE_EXPERIMENT_GROUP = "http://localhost:8080/experiments/group/";
    public static final String DELETE_EXPERIMENT_ID = "http://localhost:8080/experiments/";
}